...
export declare abstract class BaseSchemaStrategy {
     ...
     */
    abstract readRecord(db: DatabaseConnection, type: string, collection: string | null, id: string, callback?: StorageCallback<StorageRecord | null>): Promise<StorageRecord | null>;
    /**
     * Read all records of a given type
     */
    abstract readAllRecords(db: DatabaseConnection, type: string, collection: string | null, callback?: StorageCallback<StorageRecord[]>): Promise<StorageRecord[]>;
    /**
     * Delete a record from the database
     */
    abstract deleteRecord(db: DatabaseConnection, type: string, collection: string | null, id: string, callback?: StorageCallback): Promise<void>;
    /**
     ...
     */
    createIndexes(db: DatabaseConnection, collection: string, callback?: StorageCallback): Promise<void>;
    /**
     * Migrate schema from one version to another
     */
    migrateSchema(db: DatabaseConnection, fromVersion: number, toVersion: number, callback?: StorageCallback): Promise<void>;
    /**
     ...
     */
    abstract upsertInventoryItem(db: DatabaseConnection, collection: string, docId: string, version: number | string, callback?: StorageCallback): Promise<void>;
    /**
     * Remove a document from inventory
     */
    abstract deleteInventoryItem(db: DatabaseConnection, collection: string, docId: string, callback?: StorageCallback): Promise<void>;
    /**
     * Update inventory for a specific collection/document
     * @deprecated Use upsertInventoryItem or deleteInventoryItem instead
     */
    abstract updateInventoryItem(db: DatabaseConnection, collection: string, docId: string, version: number | string, operation: string, callback?: StorageCallback): Promise<void>;
    /**
     ...
     */
    readRecordsBulk?(db: DatabaseConnection, type: string, collection: string, ids: string[], callback?: StorageCallback<StorageRecord[]>): Promise<StorageRecord[]>;
}
//# sourceMappingURL=BaseSchemaStrategy.d.ts.map