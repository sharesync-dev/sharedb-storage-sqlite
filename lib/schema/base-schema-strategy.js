 ...
 * @param {Object} db - Database connection
 * @param {Object} recordsByType - Records organized by type
 ...
 * @param {Object} db - Database connection
 * @param {String} type - Record type ('docs' or 'meta')
 ...
 * @param {Number|String} version - Document version
...
BaseSchemaStrategy.prototype.readRecordsBulk = function(db, type, collection, ids, callback) {
  // Default: not implemented, will fall back to individual reads
  callback && callback(new Error('readRecordsBulk not implemented in this strategy'));
};