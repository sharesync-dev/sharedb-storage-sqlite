...
SqliteStorage.prototype.initialize = function(callback) {
  ...
  if (this.ready) {
    ...
    this.schemaStrategy.readInventory(this.adapter, callback);
    return;
  }
...
SqliteStorage.prototype.readRecord = function(storeName, id, callback) {
  ...
  this.schemaStrategy.readRecord(this.adapter, type, collection, id, function(error, record) {
    if (error) {
      callback(error);
    } else {
...
SqliteStorage.prototype.readAllRecords = function(storeName, callback) {
  ...
  this.schemaStrategy.readAllRecords(this.adapter, type, collection, callback);
};
...
SqliteStorage.prototype.readRecordsBulk = function(storeName, ids, callback) {
  ...
  this.schemaStrategy.readRecordsBulk(this.adapter, 'docs', storeName, ids, callback);
};
...
SqliteStorage.prototype.writeRecords = function(records, callback) {
  ...
  this.schemaStrategy.writeRecords(this.adapter, records, callback);
};
...
SqliteStorage.prototype.deleteRecord = function(storeName, id, callback) {
  ...
  this.schemaStrategy.deleteRecord(this.adapter, type, collection, id, callback);
};
...
SqliteStorage.prototype.clearStore = function(storeName, callback) {
  ...
  if (this.schemaStrategy.clearStore) {
    this.schemaStrategy.clearStore(this.adapter, storeName, callback);
  } else {
...
SqliteStorage.prototype.clearAll = function(callback) {
  ...
  if (this.schemaStrategy.clearAll) {
    this.schemaStrategy.clearAll(this.adapter, callback);
  } else {
...
SqliteStorage.prototype.updateInventory = function(collection, docId, version, operation, callback) {
  ...
  this.schemaStrategy.updateInventoryItem(this.adapter, collection, docId, version, operation, callback);
};
